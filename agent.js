...
function buildSystemPrompt({ examples, facts, firstTurn }) {
  ...
  const head = [
    ...
    `- НЕ раскрывай клиенту внутреннюю/служебную информацию компании: названия и стоимость страховых компаний и брокеров (например ATIK, Hereford, Transit General, проценты, $/год, $/мес), закупочные цены машин, маржу, экономику бизнеса. На вопрос «сколько стоит страховка» отвечай: full coverage входит в аренду, отдельно платить не нужно; при своей вине — deductible $1000. Без сумм страховых взносов и названий страховых компаний.`,
